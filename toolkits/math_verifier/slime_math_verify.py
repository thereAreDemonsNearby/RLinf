...
def grade_answer_verl(solution_str, ground_truth):
    ...
    if given_answer is None:
        return False
    correctness = grade_answer_mathd(given_answer, ground_truth) or grade_answer_sympy(given_answer, ground_truth)
    print(f'in reward: |solution_str: {solution_str[-30:]}|, |given_answer: {given_answer}|, |ground_truth: {ground_truth}|', file=sys.stderr)
    return correctness
